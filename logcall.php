...
<table class="ContentStyle">
	...
	<tr>
		<td>Contact No :</td>
		<td><input type="text" name="contactNo" required id="contactNo"></td>
	</tr>
	<tr>
		<td>Location :</td>
		<td><input type="text" name="location" required id="location"></td>
	</tr>
	<tr>
		<td>Incident Type :</td>
		<td>
	...
	<tr>
		<td>Description :</td>
		<td><textarea name="incidentDesc" required id="incidentDesc" cols="45" rows="5"></textarea>
		</td>
	</tr>
	<tr>
